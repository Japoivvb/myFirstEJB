 ...
 */
@WebServlet(name = "HiddenFieldServlet", urlPatterns = {"/HiddenFieldServlet"})
public class HiddenFieldServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet save cookies</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Saving data in hidden field in your browser</h1>");
