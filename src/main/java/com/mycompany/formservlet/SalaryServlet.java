...
public class SalaryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int brut = Integer.parseInt(request.getParameter("salary"));
            out.println("<p>Salari brut: " + brut + "</p>");

            int fills = Integer.parseInt(request.getParameter("children"));
            out.println("<p>Nombre de fills: " + fills + "</p>");

            out.println("<h1>Càlcul del salari net:</h1>");
            int retencio = 21 - (5 * fills);

            // Fórmula per calcular la retenció: k = (int)(value*(percentage/100.0f));
            ...
            out.println("<a href='formSalary.html'> Tornar </a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
